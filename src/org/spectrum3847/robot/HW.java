...
public class HW {
	...
	*/
	...
	public static final int SHOOTER_WHEEL_MOTOR_PDP= 8;
	...
	public static final int CLIMBER_LEFT_MOTOR_TWO_PDP = 11;
	public static final int CLIMBER_RIGHT_MOTOR_TWO_PDP = 10;
	
	public static final int BALL_INTAKE_MOTOR_PDP = 6;
    ...
    public static final int SHOOTER_WHEEL  = 24;
    public static final int BELT_BED = 22;
    public static final int NA_SHOOTER_MOTOR_BACK_LEFT   = 23;
    public static final int SHOOTER_TOWER  = 21;
    
    public static final int CLIMBER_RIGHT_MOTOR = 51;
    public static final int CLIMBER_LEFT_MOTOR = 52;
    public static final int CLIMBER_RIGHT_MOTOR_TWO = 53;
    public static final int CLIMBER_LEFT_MOTOR_TWO = 54;
    
    public static final int BALL_INTAKE_MOTOR = 41;
    
    public static final int GEAR_ARM_MOTOR = 61;
    public static final int GEAR_INTAKE_MOTOR = 62;
    
    /**DIGITAL SENSOR ALLOCATIONS**/
    public static final int GEAR_SPRING_SENSOR = 0;
    ...
    public static final int GEAR_SPEAR_SOL = 0;
    public static final int GEAR_BACK_PACK_SOL = 6;
    public static final int GEAR_FLAP_SOL = 4;
    public static final int BALL_FLAP_SOL = 5;
    public static final int HEADLIGHT_SOL = 7;
